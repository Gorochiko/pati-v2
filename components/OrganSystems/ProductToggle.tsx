    ...
    <div className="flex justify-center mb-12 lg:mb-[72px]">
      <div className="inline-flex relative bg-white rounded-full p-1.5 shadow-[0_4px_24px_rgba(80,0,11,0.08)] border border-[rgba(80,0,11,0.06)] min-w-fit">
        <button
          ...
          className={`relative z-10 inline-flex items-center justify-center px-6 py-3.5 md:px-8 md:py-4 border-none bg-transparent font-['Aeonik'] text-xs md:text-sm font-medium tracking-[0.03em] cursor-pointer transition-all duration-[280ms] ease-out whitespace-nowrap flex-1 min-w-0 ${
            activeProduct === 'essentials' 
        ...
        <span 
          className={`absolute top-1.5 left-1.5 h-[calc(100%-12px)] w-[calc(50%-6px)] rounded-full shadow-[0_4px_16px_rgba(80,0,11,0.25),0_2px_4px_rgba(164,0,17,0.15)] transition-all duration-[420ms] ease-out z-[1] ${
            activeProduct === 'essentials'
