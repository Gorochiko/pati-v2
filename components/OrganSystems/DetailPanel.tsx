...
export const DetailPanel: React.FC<DetailPanelProps> = ({ system, product }) => {
  ...
  return (
    <div className={`organ-systems__detail relative rounded-[28px] lg:rounded-[36px] border-2 overflow-hidden min-h-[340px] lg:min-h-[420px] transition-all duration-[280ms] ease-out
      ${isLongevity
    ...
    >
      ...
      {/* Content */}
      <div className="organ-systems__detail-content relative z-10 p-9 md:p-11 lg:p-[56px_52px] animate-osDetailFadeIn">
        <div className="relative z-10 flex flex-col md:flex-row gap-6 md:gap-8 items-start">
          ...
          <div className="relative flex-shrink-0">
            ...
            <span className={`absolute -top-2 -right-2 w-7 h-7 flex items-center justify-center text-white font-['Aeonik'] text-[11px] font-semibold rounded-full transition-all duration-[550ms]
              ${isLongevity
          ...
          <div className="flex-1 min-w-0">
            <h3 className={`font-['ABC_Arizona_Flare',serif] text-[clamp(24px,4vw,34px)] font-normal m-0 mb-2.5 leading-[1.15] tracking-[-0.01em] transition-colors duration-[550ms]
            ...
            <div className="flex items-center gap-4 mb-7">
              ...
              />
              <span className={`font-['Aeonik'] text-[11px] font-medium tracking-[0.18em] uppercase opacity-70 transition-all duration-[550ms]
                ${isLongevity ? 'text-[#3A0000]' : 'text-[#50000B]'}`}>
                {system.ingredients}
              </span>
            </div>

            <p className="font-['Aeonik'] text-[15px] md:text-base leading-[1.75] text-[#7B1E2A] m-0 mb-7">
              {system.description}
            </p>

            {/* Badge */}
            <div className={`inline-flex items-center gap-2.5 px-5 py-3 rounded-full border font-['Aeonik'] text-[13px] font-medium transition-all duration-[550ms]
              ${isLongevity
