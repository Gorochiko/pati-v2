const footerLinks = {
  shop: [
    { label: 'Daily Ultimate Essentials', href: '#' },
    { label: 'Daily Ultimate Longevity', href: '#' },
...
export const Footer = () => {
  return (
    <footer className="bg-foreground text-background">
      {/* Main Footer */}
      <div className="im8-container py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {/* Logo & Description */}
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-6 lg:mb-0">
            <a href="/" className="inline-block mb-4">
              <span className="text-2xl font-light tracking-[0.3em] text-background">
                I·M·8
              </span>
            </a>
            <p className="text-background/70 text-sm leading-relaxed">
              Premium core nutrition born from science. Backed by world-class scientists and co-founded by David Beckham.
            </p>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="#" className="text-background/70 hover:text-background transition-colors" aria-label="TikTok">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                </svg>
              </a>
              <a href="#" className="text-background/70 hover:text-background transition-colors" aria-label="YouTube">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-t border-background/10">
        <div className="im8-container py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-background/50 text-sm">
              © 2024 IM8 Health. All rights reserved.
            </p>
